...
TEST(RoverControllerTest, GivenStartx0y0NorthWhenForwardThenReturnx0y1North)
{
    ...
    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(0, 1)));
...
TEST(RoverControllerTest, GivenStartx5y5NorthWhenForwardThenReturnx5y6North)
{
    ...
    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(5, 6)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::North));
}

TEST(RoverControllerTest, GivenStartx3y9NorthWhenForwardThenReturnx3y0)
{
    RoverController TestController(3, 9);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(3, 9)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::North));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(3, 0)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::North));
}

TEST(RoverControllerTest, GivenStartx13y21NorthMaxGrid15WhenForwardThenReturnx13y0)
{
    RoverController TestController(13, 21, Direction::North, 15);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(13, 14)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::North));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(13, 0)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::North));
}

TEST(RoverControllerTest, GivenStartx0y0EastWhenForwardThenReturnx1y0East)
{
    RoverController TestController(0, 0, Direction::East);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(0, 0)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::East));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(1, 0)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::East));
}

TEST(RoverControllerTest, GivenStartx5y5EastWhenForwardThenReturnx6y5NEast)
{
    RoverController TestController(5, 5, Direction::East);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(5, 5)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::East));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(6, 5)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::East));
}

TEST(RoverControllerTest, GivenStartx9y2EastWhenForwardThenReturnx0y2East)
{
    RoverController TestController(9, 2, Direction::East);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(9, 2)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::East));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(0, 2)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::East));
}

TEST(RoverControllerTest, GivenStartx24y10EastMaxGrid15WhenForwardThenReturnx0y10East)
{
    RoverController TestController(24, 10, Direction::East, 15);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(14, 10)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::East));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(0, 10)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::East));
}

TEST(RoverControllerTest, GivenStartx0y0WestWhenForwardThenReturnx9y0West)
{
    RoverController TestController(0, 0, Direction::West);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(0, 0)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::West));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(9, 0)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::West));
}

TEST(RoverControllerTest, GivenStartx5y5WestWhenForwardThenReturnx4y5NWest)
{
    RoverController TestController(5, 5, Direction::West);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(5, 5)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::West));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(4, 5)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::West));
}

TEST(RoverControllerTest, GivenStartx0y7WestWhenForwardThenReturnx9y7West)
{
    RoverController TestController(0, 7, Direction::West);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(0, 7)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::West));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(9, 7)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::West));
}

TEST(RoverControllerTest, GivenStartx43y4WestMaxGrid20WhenForwardThenReturnx18y4West)
{
    RoverController TestController(43, 4, Direction::West, 20);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(19, 4)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::West));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(18, 4)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::West));
}

TEST(RoverControllerTest, GivenStartx0y0SouthWhenForwardThenReturnx0y9South)
{
    RoverController TestController(0, 0, Direction::South);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(0, 0)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::South));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(0, 9)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::South));
}

TEST(RoverControllerTest, GivenStartx5y5SouthWhenForwardThenReturnx5y4South)
{
    RoverController TestController(5, 5, Direction::South);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(5, 5)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::South));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(5, 4)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::South));
}

TEST(RoverControllerTest, GivenStartx3y9SouthWhenForwardThenReturnx3y8South)
{
    RoverController TestController(3, 9, Direction::South);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(3, 9)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::South));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(3, 8)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::South));
}

TEST(RoverControllerTest, GivenStartx6y74SouthMaxGrid43WhenForwardThenReturnx6y42)
{
    RoverController TestController(6, 74, Direction::South, 43);
    ASSERT_THAT(TestController.GetLocation(), Eq(Coordinate(6, 42)));
    ASSERT_THAT(TestController.GetDirection(), Eq(Direction::South));

    EXPECT_THAT(TestController.Forward(), Eq(Coordinate(6, 41)));
    EXPECT_THAT(TestController.GetDirection(), Eq(Direction::South));
}
